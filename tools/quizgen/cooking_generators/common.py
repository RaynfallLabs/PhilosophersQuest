"""Shared helpers for cooking generators."""
...
def make_question(
    *,
    ...
    topic_cell: str,
    strategy: str,
    pillar: str,  # practical / nutrition / cuisine / history / family_ceremony
    question: str,
    answer: str,
    distractors: Iterable[str],
    context: str,
) -> dict:
    """Construct a cooking question in live-game schema + _meta sidecar."""
    ans = str(answer)
    seen: set[str] = {ans}

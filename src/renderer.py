import pygame
from dungeon import WALL, FLOOR, STAIRS_UP, STAIRS_DOWN, DOOR
...
# Explored-but-not-visible (dimmed) tile colors
_EXPLORED = {
    WALL:        ( 60,  60,  65),
    FLOOR:       ( 25,  22,  20),
    STAIRS_UP:   ( 90,  85,  30),
...
class Renderer:
    def __init__(self, screen: pygame.Surface, viewport_tiles_w: int, viewport_tiles_h: int):
        self.screen = screen

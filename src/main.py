...
from game_helpers import (
    migrate_buc_item, cycle_tab, throw_crosses_tile,
...
from game_states import (
    ...
    STATE_ENCYCLOPEDIA,
    STATE_STORY_POPUP, STATE_MYSTERY_APPROACH, STATE_SHOP,
...
class Game(InputMixin, MenuMixin, RenderMixin, MagicMixin, EncountersMixin):

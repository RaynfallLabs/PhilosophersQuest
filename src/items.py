...
class Weapon(Item):
    def __init__(self, defn: dict):
        ...
        self.base_damage: int           = int(defn.get('base_damage', defn.get('baseDamage', 5)))
        ...
        self.chain_multipliers: list[float] = defn.get(
            'chain_multipliers', defn.get('chainMultipliers', [0.5, 1.0, 1.5, 2.0, 2.5])
        )
        ...
        _ce = defn.get('chain_exponent', defn.get('chainExponent'))
        ...
        self.ignore_shield: bool        = bool(defn.get('ignore_shield', defn.get('ignoreShield', False)))
        self.crit_multiplier: float     = float(defn.get('crit_multiplier', defn.get('critMultiplier', 1.0)))
        self.requires_ammo: str | None  = defn.get('requires_ammo', defn.get('requiresAmmo', None))
        self.infinite_ammo: bool        = bool(defn.get('infinite_ammo', defn.get('infiniteAmmo', False)))
        self.floor_spawn_weight: dict   = defn.get('floor_spawn_weight', defn.get('floorSpawnWeight', {}))
        self.container_loot_tier: str   = defn.get('container_loot_tier', defn.get('containerLootTier', 'common'))
        ...
        self.poison_chance: float       = float(defn.get('poison_chance', defn.get('poisonChance', 0.0)))
        self.burn_chance: float         = float(defn.get('burn_chance', defn.get('burnChance', 0.0)))
        self.confuse_chance: float      = float(defn.get('confuse_chance', defn.get('confuseChance', 0.0)))
        self.lifesteal_percent: float   = float(defn.get('lifesteal_percent', defn.get('lifestealPercent', 0.0)))
        self.cursed_miss_backlash: int  = int(defn.get('cursed_miss_backlash', defn.get('cursedMissBacklash', 0)))
        self.petrify_on_crit: bool      = bool(defn.get('petrify_on_crit', defn.get('petrifyOnCrit', False)))
        self.counter_attack_chance: float = float(defn.get('counter_attack_chance', defn.get('counterAttackChance', 0.0)))
        self.kill_heal_amount: int      = int(defn.get('kill_heal_amount', defn.get('killHealAmount', 0)))
        self.growing_power: bool        = bool(defn.get('growing_power', defn.get('growingPower', False)))
        self.kills_to_grow: int         = int(defn.get('kills_to_grow', defn.get('killsToGrow', 10)))
        self.on_equip_status: str       = defn.get('on_equip_status', defn.get('onEquipStatus', ''))
        ...
        self.freeze_chance: float       = float(defn.get('freeze_chance', defn.get('freezeChance', 0.0)) or 0.0)
...
def instantiate_weapon(template_id: str, material_id: str, *,
    ...
    defn = {
        ...
        # template opts in. All 22 common templates ship 1.15; uniques leave
        # this None and keep their handcrafted `chain_multipliers` arrays.
        'chain_exponent': tpl.get('chain_exponent'),

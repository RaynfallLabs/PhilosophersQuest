...
Usage: python bankbuild/geography/_integrate_passed.py <walled_build_output.json>
"""
import sys, os, time
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("usage: python bankbuild/geography/_integrate_passed.py <walled_build_output.json>")
    else:
        main(sys.argv[1])

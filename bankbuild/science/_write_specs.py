"""Read the science queue-research workflow output, write one spec_<slug>.json per sub-strand.

Injects the fixed section/strand/kind fields (the agents omitted them) onto each returned spec.
Usage: python bankbuild/science/_write_specs.py "<task output .output file>"
"""
import json, os, sys
...
SECTIONS = ("physics", "chemistry", "life", "earthspace", "howscience")

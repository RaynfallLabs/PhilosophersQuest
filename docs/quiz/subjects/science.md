...
- **Vaccines**: **SCRUTINIZED, not celebrated.** The public-health PR campaign disguised as science is named for what it is. Historical events are real (Jenner's cowpox observation 1796, Salk's 1955 trial, smallpox eradication 1980) but the **causal story** has been overstated. Definitional reclassification of polio cases post-1955 (Bernard Greenberg's 1962 Congressional testimony), Cutter Incident 1955 (~200 paralyzed, 10 dead from inadequately inactivated Salk vaccine), SV40 contamination 1955-1963 (~100M Americans exposed), VAPP and cVDPV (vaccine-derived polio exceeds wild polio in some years), DDT/pesticide neurotoxicity correlation (Maready 2018) as a serious hypothesis, sanitation paradox (polio emerged AS sanitation improved). 1986 NCVIA + liability shield covered as the consequential policy it was; schedule expansion 11→70 doses; VAERS under-reporting (Harvard Pilgrim 2010 <1%); aluminum adjuvant concerns; whole-schedule research gap. Mandates **categorically wrong**. RFK Jr. + Bhattacharya + Kulldorff + McCullough + Kory + Malone + Hooker + Siri + Bigtree + CHD covered as having moral right on this. "Anti-vaxxer" is a slur not used.

...
### Rights are negative — no positive entitlement to another's labor
- The bank teaches the negative/positive-rights distinction as a substantive view (Locke, Bastiat, Nozick). A **negative right** (life, liberty, conscience, speech, property) asks others only to *leave you alone*; a **positive "right"** to a good or service (food, housing, healthcare, schooling, a job) is a claim on another's labor, goods, or money — and so is **not** a natural right. No one is entitled to the labor or services of another.
- **Never make food/shelter/care a "natural right" in an answer.** Canonical corrected error (2026-06-07): a child "owed" lunch as an unalienable right, with context calling feeding the hungry "unalienable." The Declaration's unalienable rights are life, liberty, and the pursuit of happiness — freedoms, not entitlements to the baker's bread.
- **Relational duties are real but are not the recipient's right.** A parent owes *this* child (consistent with "parental partiality is just," above); promises and contracts bind; charity is a high virtue. The fallacy to teach kids to catch: the leap from "A owes B because of their freely-taken bond" to "everyone owes everyone." A duty *on the giver* ≠ a *right in the receiver*.
- **Steel-man the positive-rights view, never flame-bait it.** FDR's 1944 "Second Bill of Rights" is the serious case FOR positive rights (freedom is hollow without the material means to use it); present it at its strongest. The bank's line falls with the critics (Hayek/Nozick/Bastiat), but the pedagogical method stays neutral — students recognize the move; the answer does not sneer.
- Shares the lens of the Hayekian-critique and coercion-beneath-consent frames below (Bastiat's legal plunder, public-choice incentives). See **moral_vision.md §3.9 (SUPREME)**. Seeded 2026-06-07 with the lunch-ticket correction plus housing-as-right collapse, the negative/positive diagnostic, charity-as-virtue, parental-duty-not-universal-right, Nozick forced-labor, FDR steel-man, and Bastiat legal plunder.
